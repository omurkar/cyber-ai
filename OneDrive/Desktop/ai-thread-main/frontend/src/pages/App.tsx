...
// const ThreatIntelligence = lazy(() => import('../components/ThreatIntelligence')) // REMOVED
                ...
                <aside className={`${isNavOpen ? 'fixed inset-0 z-40 bg-black/95' : 'hidden'} md:block md:sticky md:top-0 md:h-screen col-span-12 md:col-span-2 border-r border-[#1a1a1a] p-6 space-y-8 transition-all duration-300`}>
                    ...
                    <nav className="flex flex-col gap-2">
                        {[
                            ...
                            // { path: "/intel", label: "Threat Intel", icon: "⚡" }, // REMOVED
                    ...
                    <div className="absolute bottom-8 left-6 right-6 p-4 rounded-2xl bg-[#bc00ff]/5 border border-[#bc00ff]/20">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[10px] font-bold text-[#bc00ff] uppercase tracking-tighter">
                                {user.email?.split('@')[0]}
                            </span>
                        </div>
                        <button onClick={logout} className="text-[9px] text-gray-400 font-medium hover:text-[#ff0055] transition-colors uppercase tracking-wider">
                            Terminate Session
                        </button>
                    </div>
                </aside>
                    ...
                    <Suspense fallback={
                        ...
                        >
                            <Routes>
                                ...
                                {/* <Route path="/intel" element={<ThreatIntelligence />} /> REMOVED */}
